...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Material.inventarnummer'
        db.delete_column(u'material_material', 'inventarnummer')

        # Adding field 'MaterialStueck.inventarnummer'
        db.add_column(u'material_materialstueck', 'inventarnummer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Material.inventarnummer'
        db.add_column(u'material_material', 'inventarnummer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'MaterialStueck.inventarnummer'
        db.delete_column(u'material_materialstueck', 'inventarnummer')
