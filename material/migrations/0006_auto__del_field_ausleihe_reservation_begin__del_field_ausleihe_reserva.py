...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ausleihe.reservation_begin'
        db.delete_column(u'material_ausleihe', 'reservation_begin')

        # Deleting field 'Ausleihe.reservation_end'
        db.delete_column(u'material_ausleihe', 'reservation_end')

        # Adding field 'Ausleihe.beginn'
        db.add_column(u'material_ausleihe', 'beginn',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 12, 0, 0)),
                      keep_default=False)

        # Adding field 'Ausleihe.ende'
        db.add_column(u'material_ausleihe', 'ende',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 12, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ausleihe.reservation_begin'
        db.add_column(u'material_ausleihe', 'reservation_begin',
                      self.gf('django.db.models.fields.DateTimeField')(default=0),
                      keep_default=False)

        # Adding field 'Ausleihe.reservation_end'
        db.add_column(u'material_ausleihe', 'reservation_end',
                      self.gf('django.db.models.fields.DateTimeField')(default=0),
                      keep_default=False)

        # Deleting field 'Ausleihe.beginn'
        db.delete_column(u'material_ausleihe', 'beginn')

        # Deleting field 'Ausleihe.ende'
        db.delete_column(u'material_ausleihe', 'ende')
    ...
    models = {
        ...
        u'material.ausleihe': {
            ...
            'beginn': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 12, 0, 0)'}),
            'bemerkungen': ('django.db.models.fields.TextField', [], {}),
            'ende': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 12, 0, 0)'}),
        ...
        u'material.materialstueck': {
            ...
            u'basemodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['material.BaseModel']", 'unique': 'True', 'primary_key': 'True'}),
            'inventarnummer': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'lagerort': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['material.LagerOrt']"}),
            'material': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'material_stueck'", 'to': u"orm['material.Material']"}),
